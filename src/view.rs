use druid::{widget::{Checkbox, Flex, Label, List}, Widget, WidgetExt, EventCtx, Env, Color, ArcStr, UnitPoint};

use crate::data::*;
use druid::widget::{TextBox, Button, Container, LabelText, RawLabel, Scroll, SizedBox, FlexParams};
...
fn settings_row() -> impl Widget<AppState> {
    ...
    let plus_button = Button::new("+").padding(5.0);
    let min_button = Button::new("-").padding(5.0);
